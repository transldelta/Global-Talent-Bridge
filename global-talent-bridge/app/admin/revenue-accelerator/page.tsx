...
const NEXT_SAFE_STEPS = [
  {
    rank:  1,
    icon:  '📥',
    label: 'Revenue Inbox prüfen',
    desc:  'Revenue Inbox öffnen → neue Leads prüfen → Strategic Partner Leads als höchste Priorität behandeln. Kein Versand, kein Outreach — nur lesen und qualifizieren.',
  ...
  },
  {
    rank:  2,
    icon:  '🌐',
    label: 'Inbound-Seiten live lassen',
    desc:  'Alle öffentlichen Seiten (/launch, /strategic-partnership, /partners, /pilot/employers) bleiben live. Google-Indexierung beobachten. Kein manuelles Teilen nötig.',
    link:  '/launch',
  ...
  },
  {
    rank:  3,
    icon:  '🔍',
    label: 'Google-Indexierung beobachten',
    desc:  'Google Search Console (bereits eingerichtet) regelmäßig prüfen — Impressionen und Klicks auf Revenue-Seiten beobachten. Kein aktives Zutun nötig.',
  ...
  },
  {
    rank:  4,
    icon:  '🧠',
    label: 'CWO Command Center prüfen',
    desc:  'Täglich oder wöchentlich das CWO Command Center öffnen — Systemstatus, Leads, Revenue-Pfade. Das System berichtet automatisch.',
    link:  '/admin/cwo-command-center',
