        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 space-y-8 text-sm leading-relaxed">
          ...
          <div className="p-4 bg-yellow-900/20 border border-yellow-800/40 rounded-xl">
            <p className="text-yellow-300 text-sm">
              <strong>Hinweis:</strong> Dies ist ein MVP-Entwurf der Allgemeinen
              Geschäftsbedingungen. Dieser Text stellt keine abschließende Rechtsberatung dar.
              Bei rechtlichen Fragen wende dich an einen qualifizierten Rechtsanwalt.
            </p>
          </div>
